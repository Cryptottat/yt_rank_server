...
class TT(models.Model):
    ...
    enter_type = models.CharField(max_length=20, null=True, default=None, verbose_name=u"진입 방법")
    now_state = models.CharField(max_length=20, null=True, default=None, verbose_name=u"상태")
    target_state = models.CharField(max_length=20, null=True, default=None, verbose_name=u"명령")
