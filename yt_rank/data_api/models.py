...
class UpdateInfoData(models.Model):
    ...
    host_name = models.CharField(max_length=50, null=True, verbose_name="컴터ID")
...
class ThreadInfoData(models.Model):
    ...
    google_logged_in = models.BooleanField(null=False, blank=True, default=False, verbose_name=u"Lg")
    ...
    last_connected_timestamp = models.BigIntegerField(null=True, blank=True, default=0, verbose_name=u"마지막 접속")
