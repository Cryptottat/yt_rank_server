...
urlpatterns = [
    ...
    re_path('get_thread_info_list_from_controller', views.GetThreadInfoListFromController.as_view(), namge='get_thread_info_list_from_controller'),
    re_path('set_thread_info_from_controller', views.SetThreadInfoFromController.as_view(), namge='set_thread_info_from_controller')
